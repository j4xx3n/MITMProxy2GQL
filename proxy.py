...
chromeCommand = "chromium-browser --proxy-server=http://127.0.0.1:8080 2>/dev/null"
args = shlex.split(chromeCommand)

try:
    print(f"Starting Chromium with proxy: {args}")
    ...
    print("The Python script will continue running with the browser in the background.")
...
async def proxy():
    ...
    print("\n\n*** Press ENTER to stop the proxy and terminate. ***\n")
